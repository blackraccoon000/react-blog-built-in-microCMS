  ...
  return (
    <Svg {...props}>
      <g>
        <Path
          {...props}
          d="M25.4,13c-0.43-1.69-1.06-3.3-1.87-4.81C23.36,7.87,23.18,7.55,23,7.24c-0.46,0.35-0.9,0.72-1.33,1.11
        ...
        <Path
          {...props}
          d="M26.06,18.28c0-0.81-0.05-1.61-0.13-2.4c-0.03-0.24-0.17-0.45-0.37-0.57c-0.5-0.29-1.02-0.56-1.55-0.81
        ...
        <Path
          {...props}
          d="M15.79,21.11c-0.16-0.13-0.35-0.23-0.56-0.26c-0.07-0.01-0.14-0.02-0.21-0.02c-0.03,0-0.07,0-0.1,0
        ...
        <Path
          {...props}
          d="M14.37,17.08c-0.51-1.57-1.2-3.05-2.04-4.44c-0.4,0.05-0.79,0.11-1.17,0.18c-1.87,0.33-3.66,0.91-5.33,1.7
        ...
        <Path
          {...props}
          d="M11.02,10.74c-0.78-1.02-1.65-1.97-2.6-2.83C7.99,7.52,7.55,7.14,7.08,6.79c-0.21,0.34-0.41,0.68-0.6,1.03
