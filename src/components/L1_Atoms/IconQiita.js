...
const IconQiita = (props) => {
  return (
    <Svg {...props}>
      <g>
        <Circle {...props} cx="167.08" cy="21.4" r="12.28" />
        <Path {...props} d="M250.81 29.66h23.48v18.9h-23.48z" />
        <Path
          {...props}
        ...
        />
        <Circle {...props} cx="216.33" cy="21.4" r="12.28" />
      </g>
    </Svg>
  );
};
...
IconQiita.defaultProps = {
  color: '#000',
  height: 12,
  width: 34,
};

export default IconQiita;
